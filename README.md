...
jobs:
  test: # make sure the action works on a clean machine without building
    ...
    steps:
      ...
      - id: test_result
        uses: khulnasoft/MeshMap-Snapshot@v0.2.6
        with:
          githubToken: ${{ secrets.GITHUB_TOKEN }} # github's personal access token example: "ghp_...."
          meshplayToken: ${{ secrets.MESHPLAY_TOKEN }} # Meshplay Cloud Authentication token, signin to meshplay-cloud to get one, example: ey.....
...
<p style="clear:both;">
<a href ="https://khulnasoft.com/community/meshmates"><img alt="MeshMates" src=".github/readme/images/community.svg" style="margin-right:10px; margin-bottom:15px;" width="28%" align="left"/></a>
